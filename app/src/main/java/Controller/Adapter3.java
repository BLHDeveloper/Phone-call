...
public class Adapter3 extends RecyclerView.Adapter<Adapter3.MyViewHolder> {
    ...
    public Adapter3(Context context, List<Data> list, DatabaseHelper databaseHelper) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.activity_favorites,parent,false);
        return new Adapter3.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull Adapter3.MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
        final Data data = List.get(position);
        holder.data.setText(data.getFirstname());
        holder.data2.setText("mobile");
